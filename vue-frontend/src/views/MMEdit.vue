...
let test = {
  ...
  data: {
    id: "root",
    topic: "澳洲銀行業傳將買更多政府債券",
    children: [
      {
        id: "HsKJbj",
        topic: "FED狂印鈔，澳元兌美元波段升3成",
        children: [
          {
            id: "mLsHpt",
            topic: "聯準會(FED)：直接持有的美國國債餘額累計增加73.9%",
          },
          {
            id: "JWherr",
            topic: "澳元兌美元",
      ...
      },
      {
        ...
        children: [
          ...
          {
            id: "oupGAe",
            topic: "墨爾本將展延封鎖期(僅有部分進行微調)至9月28日",
          },
          {
            id: "DZtzcr",
            topic:
          ...
          {
            id: "HYfoDU",
            topic: "暫時性破產保護規定將展延至今年底",
          },
          {
            id: "euaRvp",
            topic: "RBA自3月以來、累計已購買610億澳元的政府債券",
          },
        ],
      },
    ],
